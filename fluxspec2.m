function [flx,n] = fluxspec2(x,y,nfft,maxgrid,overlap)
% FLUXSPEC2: This function is used to calculated the flux spectrum at one
...
% SYNTAX
% [flx,n] = FLUXSPEC2(x,y,nfft,maxgrid,overlap)
%
% INPUT PARAMETERS
...
% >> pre=squeeze(p(300,25:39,:,49));
% >> phi=squeeze(phi(300,25:39,:,49));
% >> [flx,n] = fluxspec2(pre,phi,65,65*5,0);
% >> figure;plot(n,flx)
%
% See also:
% fluxspec
...
% $Revision: 1.0$ Created on: 29-Jul-2015 09:53:50
